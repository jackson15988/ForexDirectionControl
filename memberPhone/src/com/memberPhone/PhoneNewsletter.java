...
//		wr.writeBytes(urlParameters);
	 ...
	 * @param batchArgsMaps   訊息訊號
	 * @param mitakLoginVal   //三竹資訊登入資訊
	 * @return
	 * @return
	 */
	public static void MT4oederSMSMessage(String messageContents, HashMap<String, Object> batchArgsMaps,
			HashMap<String, Object> mitakLoginVal) {
		URL url;
		try {
			...
			String randomcode = (String) batchArgsMaps.get("randomcode");
			String custPhoneNumber = (String) batchArgsMaps.get("custPhoneNumber");
			body.append("" + randomcode + "$$" + custPhoneNumber + "$$$$$$$$$$" + messageContents + "").append("\r\n");
