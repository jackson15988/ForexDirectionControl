						...
						success : function(data) {
							...
							for (var key in data) {
								...
								if(key.includes("symbol")){	
									...
									str += "<li><a href='#' class='cowMarkst' id='cowMarkst'  onclick='return direction(&quot;"+key+"_1&quot;);'>牛市</a></li>";
									str += "<li><a href='#' class='centerMarkets' onclick='return direction(&quot;"+key+"_0&quot;);'>中立</a></li>";
									str += "<li><a href='#' class='bearMarkets' onclick='return direction(&quot;"+key+"_2&quot;);'>熊市</a></li>";
				...
				var user = {
					...
					$.ajax({
								...
								var	keyC=key.substring(0,key.length-2);
									if(key.indexOf(1) > 0){
									$(".statusImagnes_"+keyC+"").attr("src","images/589.jpg");										
									}else 	if(key.indexOf(2) >0){
										$(".statusImagnes_"+keyC+"").attr("src","images/588.jpg");		
									}else 	if(key.indexOf(0) > 0 ){
										$(".statusImagnes_"+keyC+"").attr("src","images/559.jpg");		
									}
